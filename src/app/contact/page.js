        ...
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              <span class=" mb-4 block text-green-400 font-semibold">
                Contact Us
              </span>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-green-400  mb-1 text-xl font-bold">Our Location</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-green-400  mb-1 text-xl font-bold">Phone Number</h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-green-400 mb-1 text-xl font-bold">
                    Email Address
                  </h4>
            ...
            <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    class="bg-green-400  w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
